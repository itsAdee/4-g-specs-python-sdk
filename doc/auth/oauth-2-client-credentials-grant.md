...
| OAuthScopes | `List[OauthScopeOauth2Enum]` | List of scopes that apply to the OAuth token | `oauth_scopes` |
...
from verizon.models.oauth_scope_oauth_2_enum import OauthScopeOauth2Enum
