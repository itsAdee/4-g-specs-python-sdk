...
class VerizonClient(object):
    ...
    def __init__(self, http_client_instance=None,
                 ...
                 environment=Environment.PRODUCTION, oauth_2_credentials=None,
        ...
        self.config = config or Configuration(
            ...
            environment=environment, oauth_2_credentials=oauth_2_credentials,
        ...
        self.auth_managers = {key: None for key in ['oAuth2',
                                                    'thingspace_oauth']}
        self.auth_managers['oAuth2'] = Oauth2(self.config.oauth_2_credentials,
